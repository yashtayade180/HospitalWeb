      ...
      <Card sx={{ maxWidth: 1800 }}>
        <CardContent sx={{ paddingBottom: 10 }}>
          <div className="add_btn">
            <NavLink
              to={`/dashboard/operationdetails/editop/${getuserdata._id}`}
            >
              {" "}
          ...
          <div className="row  ">
            ...
            <div className=" centre_view col-lg-3 col-md-6 col-3 ">
              <h3 className="mt-5">
                Patient Name: <span>{getuserdata.patientname}</span>
              </h3>
              <h3 className="mt-3">
                Doctor Name: <span>{getuserdata.drname}</span>
              </h3>
              <h3 className="mt-3">
                <MailOutlineIcon />
            ...
            >
              ...
              <h4 className="mt-3">
                <MailOutlineIcon />
                Remark: <span>{getuserdata.remark}</span>
              </h4>
              <h4 className="mt-3">
                <LocationOnIcon />
